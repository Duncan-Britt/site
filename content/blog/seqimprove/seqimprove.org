...
** Challenges
In order for our methods and workflows to see wider adoption in the community, we need to provide powerful and robust tools and be able to demonstrate their utility. In our lab and others, the graduate students tend to be more focused on synthetic biology than software, and the software tools like SeqImprove tend to be written by undergraduate C.S. majors who only work for a shortwhile on the project before moving on. The high turnover rate combined with the lack of experience on the part of the people making the software results in a lot of buggy software.
** Looking ahead
